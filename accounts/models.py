...
standard = [
                ...
                ('Pursuing Undergraduate', "Pursuing Undergraduate"),
                ('Pursuing Post-Undergraduate', "Pursuing Post-Undergraduate"),
...
board = [
                ...
                ('Country Board', "Outside of India"),
...
class UserProfile(models.Model):
    ...
    relationship = models.CharField( max_length=30 , choices= relation , null=True , blank=True)
    academicbackground = models.CharField( max_length=40, choices=standard , null=True , blank=True)    
    ...
    region = models.CharField(max_length=100 , choices=region, blank=True, null=True)
    country = models.CharField(max_length=100 , choices=countries, blank=True, null=True)
    state = models.CharField(max_length=100 , choices=state, blank=True, null=True)
    picture = models.ImageField(upload_to='uploads/profile_pictures', default ='default.png', null=True, blank=True)
